...
int main( void ) {
    ...
    char *sql = "DROP TABLE IF EXISTS Salas;"
                ...
                "CREATE TABLE Filmes(filme_id INTEGER PRIMARY KEY AUTOINCREMENT, Nome TEXT, Genero TEXT, Descricao TEXT);" 
                "INSERT INTO Filmes (Nome, Genero, Descricao) VALUES('Star Wars', 'Acao', 'Varios tiros e violencia no espaco');" 
                "INSERT INTO Filmes (Nome, Genero, Descricao) VALUES('Vingadores', 'Acao', 'Muitos herios para manter a conta');" 
                "INSERT INTO Filmes (Nome, Genero, Descricao) VALUES('Harry Potter', 'Aventura', 'Star Wars mas com magia e bruxos');"
